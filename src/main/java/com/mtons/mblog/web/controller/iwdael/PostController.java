...
+---------------------------------------------------------------------------
*/
package com.mtons.mblog.web.controller.iwdael;
 ...
 *
 */
@Controller("iwdaelPostController")
@RequestMapping("/iwdael/post")
public class PostController extends BaseController {
	...
	public String list(String title, ModelMap model, HttpServletRequest request) {
		...
		Page<PostVO> page = postService.paging4Iwdael(pageable, channelId, title);
		model.put("page", page);
		model.put("title", title);
		model.put("id", id);
		model.put("channelId", channelId);
		model.put("channels", channelService.findAll(Consts.IGNORE));
		return "/iwdael/post/list";
	}
	...
	public String subUpdate(PostVO post) {
		...
		return "redirect:/iwdael/post/list";
	}
