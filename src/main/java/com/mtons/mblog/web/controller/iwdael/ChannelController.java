 ...
 *
 */
@Controller("iwdaelChannelController")
@RequestMapping("/iwdael/channel")
...
//	@RequiresPermissions("channel:update")
	public String update(Channel view) {
		...
		return "redirect:/iwdael/channel/list";
	}
