...
public class RoleController extends BaseController {
	...
	public String update(Role role, @RequestParam(value = "perms", required=false) List<Long> perms, ModelMap model) {
        ...
        model.put("data", data);
        return "redirect:/iwdael/role/list";
	}
