        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <a class="btn btn-default btn-sm" href="${base}/iwdael/post/view">新建</a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="${base}/iwdael/post/view?id=${row.id}" class="btn btn-xs btn-info">修改</a>
...
function doDelete(ids) {
	J.getJSON('${base}/iwdael/post/delete', J.param({'id': ids}, true), ajaxReload);
}

function doUpdateFeatured(id, featured) {
    J.getJSON('${base}/iwdael/post/featured', J.param({'id': id, 'featured': featured}, true), ajaxReload);
}

function doUpdateWeight(id, weight) {
    J.getJSON('${base}/iwdael/post/weight', J.param({'id': id, 'weight': weight}, true), ajaxReload);
}
