        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <a class="btn btn-default btn-sm" href="${base}/iwdael/channel/view">添加栏目</a>
                    </div>
                </div>
                <div class="box-body">
...
<script type="text/javascript">
    ...
    function doUpdateWeight(id, weight) {
        J.getJSON('${base}/iwdael/channel/weight', J.param({'id': id, 'weight': weight}, true), ajaxReload);
    }
    ...
    $(function () {
        ...
        $('#dataGrid a[data-action="delete"]').bind('click', function () {
            ...
            layer.confirm('确定删除此项吗?', {
                ...
                J.getJSON('${base}/iwdael/channel/delete', {id: that.attr('data-id')}, ajaxReload);
            }, function () {
            });
            return false;
        });
