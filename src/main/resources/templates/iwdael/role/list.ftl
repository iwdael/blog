        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <a class="btn btn-default btn-sm" href="${base}/iwdael/role/view">添加角色</a>
                    </div>
                </div>
                <div class="box-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <#if row.id != 1>
                                            <a href="${base}/iwdael/role/view?id=${row.id}" class="btn btn-xs btn-success">
...
<script type="text/javascript">
    ...
    function doDelete(ids) {
        J.getJSON('${base}/iwdael/role/delete', J.param({'id': ids}, true), ajaxReload);
    }
