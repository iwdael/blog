...
<head>
    ...
    <!-- Theme Style -->
    <link href="${base}/theme/iwdael/dist/css/site.css" rel="stylesheet">
    <link href="${base}/theme/iwdael/dist/css/site.addons.css" rel="stylesheet">
    <link href="${base}/theme/iwdael/dist/css/skins/skin-blue.css" rel="stylesheet">
    ...
    <script src="${base}/theme/iwdael/dist/js/site.js"></script>
    <script src="${base}/theme/iwdael/dist/js/site.base.js"></script>
</head>
    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li>
                    <a href="${base}/iwdael" class="active"><i class="fa fa-dashboard"></i><span>仪表盘</span></a>
                </li>
                <@menus>
